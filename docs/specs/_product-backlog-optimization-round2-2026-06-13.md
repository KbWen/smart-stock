...
created: 2026-06-13
last_updated: 2026-06-13 (ALL 3 Shipped — #3 PR #22, #2 PR #23, #1 PR #24)
archived: 2026-06-20 (epic complete; superseded by Directly-Usable v1 backlog in _product-backlog.md)
---

# Product Backlog

> **ARCHIVED 2026-06-20** — All 3 features shipped; this epic is complete. The active living backlog is now `_product-backlog.md` (Directly-Usable v1). This file is retained as historical reference only.
...
| 1 | Frictionless onboarding — one-command quickstart + seeded demo data + README run-through so a newcomer runs it in minutes | feature | onboarding | P1 | docs/specs/onboarding-quickstart.md | feature | Shipped | — |
