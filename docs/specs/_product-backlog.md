...
| 5 | Reproducible Reference Layer — one-command data→label→train→backtest→eval flow + walkthrough doc for the developer/learner audience (Docker self-seed already exists) | feature | docs, ml | P2 | docs/specs/reproducible-reference.md | feature | In Progress | — |
