...
created: 2026-09-02
last_updated: 2026-09-02 (#1 and #2 Shipped; #6 spec frozen, in progress)
---
...
| 6 | Docs-vs-reality alignment — correct the four `DATA_INTEGRITY.md` claims, `README.md:237` 「完全杜絕」, the whitepaper's `auto_adjust` assertion, and the `risk_level` naming plus its tooltip (F3, 3/3 auditors) | review-finding | docs | P0 | docs/specs/docs-reality-alignment.md | feature | In Progress | #1, #2 |
