    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-lg bg-dark-border/10 p-4 space-y-4">
                {renderProgressBar('Trend', safeScores.trend, 40, 'bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]')}
                {renderProgressBar('Momentum', safeScores.momentum, 30, 'bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]')}
                {renderProgressBar('Volatility', safeScores.volatility, 30, 'bg-yellow-500 shadow-[0_0_10px_rgba(234,179,8,0.5)]')}
            </div>
        </div>
    )
}
