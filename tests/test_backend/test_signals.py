...
# We need to import generate_signals from the backend
# But it's defined as a module-level function, so we import it directly
from backend.main import generate_signals


class TestGenerateSignals:
    """Verify signal generation logic against known indicator states."""

    @patch('backend.main.load_indicators_from_db', return_value=None)
    ...
    @patch('backend.main.load_indicators_from_db')
