...
- **Active Backlog**: `docs/specs/_product-backlog.md` (**Honest Research Workbench** epic, opened 2026-07-02: #1 Strategy Lab ✅ **Shipped**, #2 Transparency Panel, #3 Explainable Screening, #4 Novice Entry, #5 Reproducible Reference Layer, #6 CSRF-parity [review-finding] — #2–6 Pending. Differentiator = transparency, not prediction accuracy; progressive disclosure for novice+expert. Prior Directly-Usable v1 backlog [all 6 shipped] archived to `docs/specs/_product-backlog-directly-usable-v1-2026-06-20.md`)
