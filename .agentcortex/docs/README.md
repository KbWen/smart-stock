# AgentCortex v5.3: The Professional Agentic OS for Google Antigravity & Codex
...
A library of 12 professional agentic skills, each with auto-trigger metadata declaring which workflow phases activate them:
