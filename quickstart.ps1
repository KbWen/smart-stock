...
Write-Host ""
Write-Host "Note: no AI model is bundled, so AI probability shows N/A. For REAL AI"
Write-Host "      (opt-in, slower): python scripts/setup_real_ai.py  (syncs full market, then trains)."
Write-Host "      Technical scores already work offline."
